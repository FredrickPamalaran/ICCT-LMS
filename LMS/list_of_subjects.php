...
<html lang="en">
	<head>
		...
		<title>ICCT LMS | Subject page</title>
	</head>
	<body>
		...
		<header class="mb-5" data-mdb-sticky-position="top">
			<nav class="navbar navbar-expand-md bg-light navbar-light shadow">
				<div class="container">
					<a href="#" class="navbar-brand">ICCT LMS | List of Subjects</a>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 mx-md-2">
						...
						<div class="subject-container d-flex flex-column-reverse"></div>
					</div>
		...
		<!-- importing app.js -->
		<script type="module" src="javascripts/list_of_subjects.js"></script>
	</body>
</html>
