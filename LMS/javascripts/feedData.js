...
export let feedData = [
	//******************************************************************** */
	{
		...
		subjectLink: './subject_page.php',
		quizLink: './quiz_page.php',
		quizLinkAtHomePage: '../quiz_page.php',
		questions: [
			{
				questionNum: 1,
				question:
			...
			},
			{
				questionNum: 3,
				question:
					'Using only an addition, how do you add eight 8s and get the number 1000?',
				a: '1000',
				b: '888',
				c: '41',
				d: '54 ',
